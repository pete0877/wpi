...
const CInterfaceProxyVtbl * _TestServer_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IHelperRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * _TestServer_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IHelperRegistrarStubVtbl,
    0
};

PCInterfaceName const _TestServer_InterfaceNamesList[] = 
{
    "IHelperRegistrar",
    0
};
...
#define _TestServer_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _TestServer, pIID, n)

int __stdcall _TestServer_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_TestServer_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo TestServer_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _TestServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _TestServer_StubVtblList,
    (const PCInterfaceName * ) & _TestServer_InterfaceNamesList,
    0, // no delegation
    & _TestServer_IID_Lookup, 
    1,
    2,
