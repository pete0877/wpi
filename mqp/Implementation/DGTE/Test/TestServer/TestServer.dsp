...
!MESSAGE 
!MESSAGE "TestServer - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "TestServer - Win32 Unicode Debug" (based on "Win32 (x86) Application")
!MESSAGE "TestServer - Win32 Release MinSize" (based on "Win32 (x86) Application")
!MESSAGE "TestServer - Win32 Release MinDependency" (based on "Win32 (x86) Application")
!MESSAGE "TestServer - Win32 Unicode Release MinSize" (based on "Win32 (x86) Application")
!MESSAGE "TestServer - Win32 Unicode Release MinDependency" (based on "Win32 (x86) Application")
!MESSAGE 
...
OutDir=.\Debug
TargetPath=.\Debug\TestServer.exe
TargetName=TestServer
InputPath=.\Debug\TestServer.exe
SOURCE="$(InputPath)"
...
# Begin Custom Build - Performing registration
OutDir=.\DebugU
TargetPath=.\DebugU\TestServer.exe
InputPath=.\DebugU\TestServer.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinSize\TestServer.exe
InputPath=.\ReleaseMinSize\TestServer.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinDependency\TestServer.exe
InputPath=.\ReleaseMinDependency\TestServer.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinSize\TestServer.exe
InputPath=.\ReleaseUMinSize\TestServer.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinDependency\TestServer.exe
InputPath=.\ReleaseUMinDependency\TestServer.exe
SOURCE="$(InputPath)"
...
# Name "TestServer - Win32 Unicode Debug"
# Name "TestServer - Win32 Release MinSize"
# Name "TestServer - Win32 Release MinDependency"
# Name "TestServer - Win32 Unicode Release MinSize"
# Name "TestServer - Win32 Unicode Release MinDependency"
...
# ADD MTL /tlb ".\TestServer.tlb" /h "TestServer.h" /iid "TestServer_i.c" /Oicf
# End Source File
# Begin Source File
