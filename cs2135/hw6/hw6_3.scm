...
; This code also includes definitions from prob #1 and some from #2
; The functions modified are : eval-op, binrop?
; New functions are          : Intersect
; eval-rexp is not modified
