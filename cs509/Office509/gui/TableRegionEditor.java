...
public class TableRegionEditor extends Panel implements PropertyEditor, KeyListener {
  ...
  public void keyTyped (KeyEvent ke) {
    ...
    int intC1 = Integer.valueOf(c1.getText()).intValue();
    int intR1 = Integer.valueOf(r1.getText()).intValue();
    int intC2 = Integer.valueOf(c2.getText()).intValue();
    int intR2 = Integer.valueOf(r2.getText()).intValue();
  ...
  public void setValue(Object o) {
    ...
    // update the fields
    System.out.println ("TBE: setValue");
  ...
  public String getJavaInitializationString() {
    return "new adapt.gui.TableRegion(" +
      "new adapt.gui.TableElement (" + c1.getText() + "," + r1.getText() +")," +
      "new adapt.gui.TableElement (" + c2.getText() + "," + r2.getText() +"))";
  }
