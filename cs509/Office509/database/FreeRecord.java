    ...
    */
        ...
        if (fields.size()>1) {
            for (a=0; a<fields.size()-1; a++) {
                ...
                for (b=a+1; b<fields.size(); b++) {
                    ...
                    if (field1.getName().equals(field2.getName())) throw new DatabaseException("Dupe(s) in field names.");
                }
            }                    
        }
    ...
    public Field getField (String s) {        
        ...
        for (int a=0; a<fields.size(); a++)        
            if (((Field)fields.elementAt(a)).getName().equals(s)) return (Field)fields.elementAt(a);
		return null;
	}
    ...
    */  
    public String asString() {
        ...
        for (int a=0; a<fields.size(); a++) {
            ...
            if (f.getName().equals(primary)) result = result + "*";
