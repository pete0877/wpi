...
public class Database implements DatabaseInterface {
   ...
   ////////////////////////////////////////////////////////////////////////////    	    
    ...
    public void addRecord (FreeRecord fr) throws DatabaseException {
        ...
        if (!definition.getPrimaryField().getName().equals(fr.getPrimaryField().getName())) throw new DatabaseException("Invalid new record.");
        ...
        for (int a=0; a<records.size(); a++) {
            ...
            Field tmpField = r.getPrimaryField();
            String tmpStr = tmpField.getValue();
            if (tmpStr.equals(newPK)) {
                throw new DatabaseException("Primary key violation");
            }
        }
    ...
    public boolean updateRecord (RecordInterface ri, Vector fieldVector) throws DatabaseException {        
        ...
        if (!definition.getPrimaryField().getName().equals(ri.getPrimaryField().getName())) throw new DatabaseException("Invalid update specifications.");
    ...
    public FreeRecord getTemplate () {      
        ...
        FreeRecord result=null;
        try {
            result = new FreeRecord(definition.getFieldsVect(), definition.getPrimaryField().getName());
